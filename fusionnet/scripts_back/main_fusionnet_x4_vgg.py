...
# from model_sigmoid import FusionNet
...
def loop(cfg, train_provider, valid_provider, model, criterion, optimizer, iters, writer):
    ...
    while iters <= cfg.TRAIN.total_iters:
        ...
        loss_fusionnet = criterion(pred, target)
        ...
        loss = loss_fusionnet + vgg_weight * loss_vgg2
        ...
        if iters % cfg.TRAIN.display_freq == 0:
            ...
            logging.info('step %d, loss_fusionnet = %.4f, loss_vgg = %.4f' % (iters, loss_fusionnet, vgg_weight * loss_vgg2))
            writer.add_scalar('loss/loss_fusionnet', loss_fusionnet, iters)
...
if __name__ == "__main__":
    ...
    if cfg.TRAIN.track == 'simple':
        ...
        from data_complx_scale import Provider
    ...
    if args.mode == 'train':
        ...
        if cfg.TRAIN.track == 'simple':
            ...
            if cfg.TEST.mode == 'train':
                test_path = '../train_result/complex'
                base_path = '../../data/complex/' + cfg.TEST.crop_way + '/train_raw_whole'
            elif cfg.TEST.mode == 'valid':
                test_path = '../valid_result/complex'
                base_path = '../../data/complex/' + cfg.TEST.crop_way + '/valid_raw'
            elif cfg.TEST.mode == 'test':
