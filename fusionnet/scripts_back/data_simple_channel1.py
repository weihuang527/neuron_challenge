...
class Train(Dataset):
	...
	def __getitem__(self, index):
		# random crop
		i = random.randint(0, self._raw_input.shape[1] - self.crop_size[0])
		j = random.randint(0, self._raw_input.shape[2] - self.crop_size[1])
		k = random.randint(0, self.num - 1)
		
		im = self._raw_input[k, i:i+self.crop_size[0], j:j+self.crop_size[1]]
		lb = self._raw_labels[k, i:i+self.crop_size[0], j:j+self.crop_size[1]]
...
if __name__ == '__main__':
	...
	cfg_file = 'simple_UNETPP_2_1024_padding0.yaml'
