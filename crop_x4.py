...
if __name__ == "__main__":
    ...
    mode = args.mode
    print('Crop training data in x4 resolution under mode ' + str(mode))
    ...
    if mode == 1:
        ...
        out_train_path = './data/complex/crop_x4_1024/train_raw'
        out_label_path = './data/complex/crop_x4_1024/train_label'
        out_valid_raw_path = './data/complex/crop_x4_1024/valid_raw'
        out_valid_label_path ='./data/complex/crop_x4_1024/valid_label'
        ...
        train_txt = './data/data_list/complex_crop_x4_1024_train_list.txt'
        valid_txt = './data/data_list/complex_crop_x4_1024_valid_list.txt'
        txt_raw_path = 'complex/crop_x4_1024/train_raw/'
        txt_label_path = 'complex/crop_x4_1024/train_label/'
        txt_valid_raw_path = 'complex/crop_x4_1024/valid_raw/'
        txt_valid_label_path = 'complex/crop_x4_1024/valid_label/'
        ...
        for f in file_list_png:
            if f not in valid_dataset:
                ...
                raw_pad = cv2.resize(raw_pad, (out_img_size, out_img_size), interpolation=cv2.INTER_LINEAR)
                label_pad = cv2.resize(label_pad, (out_img_size, out_img_size), interpolation=cv2.INTER_NEAREST)
                cv2.imwrite(os.path.join(out_valid_raw_path, f), raw_pad)
                cv2.imwrite(os.path.join(out_valid_label_path, name+'.tiff'), label_pad)
        ...
        out_train_path = './data/complex/crop_x4_1024/train_raw_k2'
        out_label_path = './data/complex/crop_x4_1024/train_label_k2'
        out_valid_raw_path = './data/complex/crop_x4_1024/valid_raw_k2'
        out_valid_label_path ='./data/complex/crop_x4_1024/valid_label_k2'
        ...
        train_txt = './data/data_list/complex_crop_x4_1024_train_k2_list.txt'
        valid_txt = './data/data_list/complex_crop_x4_1024_valid_k2_list.txt'
        txt_raw_path = 'complex/crop_x4_1024/train_raw_k2/'
        txt_label_path = 'complex/crop_x4_1024/train_label_k2/'
        txt_valid_raw_path = 'complex/crop_x4_1024/valid_raw_k2/'
        txt_valid_label_path = 'complex/crop_x4_1024/valid_label_k2/'
        ...
        out_train_path = './data/complex/crop_x4_1024/train_raw_all'
        out_label_path = './data/complex/crop_x4_1024/train_label_all'
        ...
        train_txt = './data/data_list/complex_crop_x4_1024_train_all_list.txt'
        txt_raw_path = 'complex/crop_x4_1024/train_raw_all/'
        txt_label_path = 'complex/crop_x4_1024/train_label_all/'
